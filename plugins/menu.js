...
`
   ...
   conn.send3ButtonImg(m.chat, img, `${petik}Hello ${name} ${petik} \n${petik}Im ${conn.getName(conn.user.jid)} ${petik} `, text.trim(), 'Pemilik Bot', '.owner', 'Donasi', '.donasi', 'Rules', '.rules', m)
